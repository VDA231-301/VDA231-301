...
Aligned with the generic schema v3.0.0, in which
`ComponentMaster.Colors` and `ComponentInstance.ColorID` are defined.
Validation against this schema version should be performed before productive
use.
